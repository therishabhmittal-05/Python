...
3. How to initialize  instance variable and methods
"""
...
# Instance Variables(Contains Data specific(or UNIQUE) to each instance) ---> THIS LINE IS MORE IMPORTANT TO UNDERSTAND
# In the eg below name, email, role are instance variables they are going to be different for each Employee
